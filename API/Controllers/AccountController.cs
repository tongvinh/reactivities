...
namespace API.Controllers
{
  ...
  public class AccountController : ControllerBase
  {
    ...
    public async Task<ActionResult<UserDto>> Login(LoginDtos loginDtos)
    {
      ...
      .FirstOrDefaultAsync(x => x.Email == loginDtos.Email);
    ...
    public async Task<ActionResult<UserDto>> Register(RegisterDto registerDto)
    {
      ...
      var message = $"<p>Please click the below link to verify email address:</p><p><a href='{verifyUrl}'>Click to verify email</a></p>";
    ...
    public async Task<ActionResult<UserDto>> RefreshToken()
    {
      ...
      var user = await _userManager.Users.Include(x => x.RefreshTokens).Include(p => p.Photos)
